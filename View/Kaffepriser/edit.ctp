...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Kaffepris.nummer')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Kaffepris.nummer'))); ?></li>
