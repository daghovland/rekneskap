...
<h2><?php  __('Kaffiinnkjop');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Kaffitype'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Pengeflytting'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
		...
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Kaffeflytting'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
