...
<?php echo $this->Form->create('Rekning');?>
	<fieldset>
		<legend><?php echo __('Edit Rekning'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Rekning.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Rekning.id'))); ?></li>
