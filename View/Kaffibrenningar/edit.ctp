...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Delete', true), array('action'=>'delete', $this->Form->value('Kaffibrenning.id')), null, sprintf('Are you sure you want to delete # %s?', $this->Form->value('Kaffibrenning.id'))); ?></li>
