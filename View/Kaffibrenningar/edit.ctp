...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Delete', true), array('action'=>'delete', $form->value('Kaffibrenning.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Kaffibrenning.id'))); ?></li>
