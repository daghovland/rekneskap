...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Delete', true), array('action'=>'delete', $this->Form->value('Selger.nummer')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Selger.nummer'))); ?></li>
