...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Faktura.nummer')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Faktura.nummer'))); ?></li>
