...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Kaffiinnkjop', true), array('action' => 'edit', $kaffiinnkjop['Kaffiinnkjop']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Kaffiinnkjop', true), array('action' => 'delete', $kaffiinnkjop['Kaffiinnkjop']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $kaffiinnkjop['Kaffiinnkjop']['id'])); ?> </li>
