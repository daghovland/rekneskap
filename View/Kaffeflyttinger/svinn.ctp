<div class="kaffeflyttinger form">
  ...
  <fieldset>
    <legend><?php echo __('Svinn kaffi');?></legend>
    <?php
    ...
    ;
    echo $this->Form->input('antall', array('options' => range(0,$standardBeholdninger[count($kaffetypenavn)]), 'id' => 'KaffeflyttingAntall'));
