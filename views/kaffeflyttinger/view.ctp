...
<h2><?php  __('Kaffeflytting');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $html->link($kaffeflytting['Fra']['beskrivelse'], array('controller'=> 'kaffelagre', 'action'=>'view', $kaffeflytting['Fra']['nummer'])); ?>(<?php echo $html->link($kaffeflytting['Fralagertypenavn']['navn'], array('controller'=> 'lagertyper', 'action'=>'view', $kaffeflytting['Fralagertypenavn']['nummer'])); ?>)
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $html->link($kaffeflytting['Til']['beskrivelse'], array('controller'=> 'kaffelagre', 'action'=>'view', $kaffeflytting['Til']['nummer'])); ?>(<?php echo $html->link($kaffeflytting['Tillagertypenavn']['navn'], array('controller'=> 'lagertyper', 'action'=>'view', $kaffeflytting['Tillagertypenavn']['nummer'])); ?>)
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $html->link($kaffeflytting['Kontantbetaling']['nummer'], array('controller'=> 'pengeflyttinger', 'action'=>'view', $kaffeflytting['Kontantbetaling']['nummer'])); ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Kaffibrenning'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $html->link($kaffeflytting['Kaffibrenning']['navn'], array('controller'=> 'kaffibrenninger', 'action'=>'view', $kaffeflytting['Kaffibrenning']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $html->link($kaffeflytting['Kaffesalg']['nummer'], array('controller' => 'kaffesalg', 'action' => 'view', $kaffeflytting['Kaffesalg']['nummer'])); ?>
			&nbsp;
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Endre Kaffeflytting', true), array('action'=>'edit', $kaffeflytting['Kaffeflytting']['nummer'])); ?> </li>
		<li><?php echo $html->link(__('Slett Kaffeflytting', true), array('action'=>'delete', $kaffeflytting['Kaffeflytting']['nummer']), null, sprintf(__('Are you sure you want to delete # %s?', true), $kaffeflytting['Kaffeflytting']['nummer'])); ?> </li>
		<li><?php echo $html->link(__('List Kaffeflyttinger', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('Ny Kaffeflytting', true), array('action'=>'add')); ?> </li>
		...
		<li><?php echo $html->link(__('Ny Kaffetype', true), array('controller'=> 'kaffepriser', 'action'=>'add')); ?> </li>
