...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Endre Startsaldo', true), array('action'=>'edit', $startsaldo['Startsaldo']['id'])); ?> </li>
		<li><?php echo $html->link(__('Slett Startsaldo', true), array('action'=>'delete', $startsaldo['Startsaldo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $startsaldo['Startsaldo']['id'])); ?> </li>
		<li><?php echo $html->link(__('List Startsaldoer', true), array('action'=>'index')); ?> </li>
		<li><?php echo $html->link(__('Ny Startsaldo', true), array('action'=>'add')); ?> </li>
