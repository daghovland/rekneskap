...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Lagerverditype', true), array('action'=>'edit', $lagerverditype['Lagerverditype']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Lagerverditype', true), array('action'=>'delete', $lagerverditype['Lagerverditype']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $lagerverditype['Lagerverditype']['id'])); ?> </li>
